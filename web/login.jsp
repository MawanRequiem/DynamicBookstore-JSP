    ...
    <div class="frame">
        ...
        <div ng-app ng-init="checked = false">
           <form class="form-signin" action="<%=request.getContextPath()%>/loginServlet" method="post" name="form"> 
              ...
              <input class="form-styling" type="text" name="username" placeholder="Masukkan Username" id="uName" />

              <label for="password">Password</label> 
              <input class="form-styling" type="password" name="password" placeholder="Masukkan Password" id="pWord" />

              <input type="checkbox" id="checkbox" /> 
              <label for="checkbox"><span class="ui"></span>Keep me signed in</label>

              <div class="btn-animate">
                  <input type="submit" class="btn-signin" value="Login to your account">
              </div>
          </form>


            <!<!-- signup -->
     <form class="form-signup" action="<%=request.getContextPath()%>/registerServlet" method="post" name="form"> 
    <label for="fullname">Full name</label> 
    <input class="form-styling" type="text" name="fullname" placeholder="Enter Full Name" id="fullName" />

    <label for="username">Username</label>
    <input class="form-styling" type="text" name="username" placeholder="Enter Username" id="uName" /> 

    <label for="email">Email</label>
    <input class="form-styling" type="text" name="email" placeholder="Enter Email" id="eMail"/> 

    <label for="password">Create password</label> 
    <input class="form-styling" type="password" name="password" placeholder="Enter Password" id="pWord" /> 

    <button type="submit" class="btn-signup" style="color: white;">REGISTER</button>
</form>
